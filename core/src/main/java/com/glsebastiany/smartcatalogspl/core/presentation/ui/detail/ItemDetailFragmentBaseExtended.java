...
public class ItemDetailFragmentBaseExtended extends ItemDetailFragmentBase<ItemDetailPresenterExtended, ItemComposition>{

    public static ItemDetailFragmentBaseExtended newInstance(String itemId){
        return ItemDetailFragmentBaseExtended_.builder().itemId(itemId).build();
    }
