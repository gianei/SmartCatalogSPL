...
package com.glsebastiany.smartcatalogspl.core.presentation.greendao.category;
...
public class CategoryGreendaoRepository implements CategoryRepository{
    ...
    public List<? extends CategoryModel> loadAll() {
        ...
        categories.add(new CategoryEntity(Utils.parseLong(ID_PROMOTION), CategoryModel.ROOT_ID, "Promoções"));
        categories.add(new CategoryEntity(Utils.parseLong(ID_SALE), CategoryModel.ROOT_ID, "Liquidação"));
        categories.add(new CategoryEntity(Utils.parseLong(ID_NEW), CategoryModel.ROOT_ID, "Novidades"));
        categories.add(new CategoryEntity(Utils.parseLong(ID_PROMOTION_AND_SALE), CategoryModel.ROOT_ID, "Promoções e Liquidação"));
        categories.add(new CategoryEntity(Utils.parseLong(ID_OTHER), CategoryModel.ROOT_ID, "Outro"));
    ...
    private CategoryModel getSpecialCategory(String categoryId) {
        ...
        switch (categoryId){
            case ID_PROMOTION:
                category = new CategoryEntity(Utils.parseLong(ID_PROMOTION), CategoryModel.ROOT_ID, "Promoções");
                break;
            case ID_SALE:
                category = new CategoryEntity(Utils.parseLong(ID_SALE), CategoryModel.ROOT_ID, "Liquidação");
                break;
            case ID_NEW:
                category = new CategoryEntity(Utils.parseLong(ID_NEW), CategoryModel.ROOT_ID, "Novidades");
                break;
            case ID_PROMOTION_AND_SALE:
                category = new CategoryEntity(Utils.parseLong(ID_PROMOTION_AND_SALE), CategoryModel.ROOT_ID, "Promoções e Liquidação");
                break;
            default:
                category = new CategoryEntity(Utils.parseLong(ID_OTHER), CategoryModel.ROOT_ID, "Outro");
        }
