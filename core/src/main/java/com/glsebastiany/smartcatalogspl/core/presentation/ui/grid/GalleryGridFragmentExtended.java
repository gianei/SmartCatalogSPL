...
public class GalleryGridFragmentExtended extends GalleryGridFragmentBase<GalleryGridPresenterExtended, ItemComposition> {
    ...
    @NonNull
    @Override
    protected GalleryGridItemsAdapterBase<ItemComposition> getGalleryGridItemsAdapter() {
