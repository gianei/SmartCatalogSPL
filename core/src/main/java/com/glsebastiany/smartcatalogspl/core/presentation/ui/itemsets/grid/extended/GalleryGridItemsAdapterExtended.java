...
public class GalleryGridItemsAdapterExtended extends GalleryGridItemsAdapterBase<ItemExtendedModel> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int baseItemPosition) {
        ...
        ItemExtendedModel promotedModel = items.get(baseItemPosition);
    ...
    public int getItemViewType(int baseItemPosition) {
        ItemExtendedModel item = items.get(baseItemPosition);
    ...
    public void addItem(ItemExtendedModel itemExtendedModel) {
        items.add(itemExtendedModel);
