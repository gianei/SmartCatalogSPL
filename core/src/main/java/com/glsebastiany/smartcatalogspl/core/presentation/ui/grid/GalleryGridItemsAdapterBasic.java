...
public class GalleryGridItemsAdapterBasic extends GalleryGridItemsAdapterBase<ItemBasicModel> {
    ...
    public GalleryGridItemsAdapterBasic(GalleryGridCallbacks galleryGridCallbacks){
