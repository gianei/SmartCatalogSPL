...
@RequiresPresenter(ItemDetailPresenterBase.class)
public class ItemDetailFragmentBaseBasic extends ItemDetailFragmentBase<ItemDetailPresenterBase, ItemBasicModel>{

    public static ItemDetailFragmentBaseBasic newInstance(String itemId){
        return ItemDetailFragmentBaseBasic_.builder().itemId(itemId).build();
    }
