...
@RequiresPresenter(GalleryGridPresenterBase.class)
public class GalleryGridFragmentBasic extends GalleryGridFragmentBase<GalleryGridPresenterBase, ItemBasicModel> {

    public static GalleryGridCallbacks newInstance(String searchQuery, boolean isCategoryIdQuery) {
        return GalleryGridFragmentBasic_.builder()
    ...
    protected GalleryGridItemsAdapterBase<ItemBasicModel> getGalleryGridItemsAdapter() {
        return new GalleryGridItemsAdapterBasic(this);
    }
}
