...
package com.glsebastiany.smartcatalogspl.instanceditlanta.presentation.tabbedgallery;
...
public class PagerAdapter extends FragmentStatePagerAdapter implements Observer<CategoryModel> {
    ...
    public Fragment getItem(int position) {
        return baseAppDisplayFactory.provideGalleryFragment(categories.get(position).getStringId());
    }
